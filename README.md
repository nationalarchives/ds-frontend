...
| `COOKIE_PREFERENCES_KEY`               | The cookie key specifying the cookie preferences                                                     | `cookie_preferences`                                 |
| `COOKIE_PREFERENCES_SET_KEY`           | The cookie key specifying that the preferences have been set                                         | `cookie_preferences_set`                             |
...
| `OG_EXTERNAL_CONTENT_MAX_TITLE_LENGTH` | When scraping content to generate an OG image, the maximum length for the title before tuncating     | `60`                                                 |
| `OG_EXTERNAL_CONTENT_MAX_BODY_LENGTH`  | When scraping content to generate an OG image, the maximum length for the body text before tuncating | `160`                                                |
